package generationBrasil.Nexo.Configuration;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Nexo")
				.description("Projeto integrador - rede social de iniciacao academica e profissional").version("1.0.0")
				.license("Apache License Version 2.0").licenseUrl("https://github.com/ccarmo/nexo").contact(contact())
				.build();
	}

	private static Contact contact() {
		return new Contact("Nexo", "https://github.com/ccarmo/nexo", "nexoredesocial@gmail.com");
